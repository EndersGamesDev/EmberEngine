...
import {castleView} from '../../web/games/end-game/v10/castle-ui.js';
import {CASTLE_LINES} from '../../web/games/end-game/v10/voice-lines.js';
...
test('every shipped castle voice matches its caption duration and generated source bytes',()=>{
  ...
  for(const line of Object.values(CASTLE_LINES)) {
    const file=readFileSync(new URL(`../../web/games/end-game/v10/${line.file}`,import.meta.url));
