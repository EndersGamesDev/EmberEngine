"""Inspect the actual generated source from four sides, without altering it."""
import bpy
...
out=Path(os.environ['END_GAME_V7_WORK']);out.mkdir(parents=True,exist_ok=True)
...
for name,location in [('front',(0,3.8,1.15)),('right',(3.8,0,1.15)),('back',(0,-3.8,1.15)),('left',(-3.8,0,1.15))]:
...
print('V7_SOURCE_INSPECTION',json.dumps(record),flush=True)
