...
const output = path.resolve(process.env.EMBER_QA_OUTPUT || path.join(root, 'target', 'shotgun-grip-captures'));
const names = ['Sidearm', 'Vityaz', 'AK-47', 'M4', 'Revolver', 'Sniper', 'RPG-7', 'Breach-12'];
