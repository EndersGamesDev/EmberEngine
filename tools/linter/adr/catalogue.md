...
Each program fixes one allowance codec—path count, path set, or fingerprint—and every routed program names its own recognizer and observer. These codecs retain the identities and comparison semantics fixed by ADR-L-020, The migration disciplines.
