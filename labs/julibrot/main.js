...
async function boot() {
  try {
    ...
    BOOT_FACTS = Object.freeze({
      ...
      timer_probe: timer,
      wasm_bundle_bytes: await artifactBytes("./pkg/ember_lab_julibrot_bg.wasm?v=1788700511"),
      javascript_bundle_bytes: await artifactBytes("./pkg/ember_lab_julibrot.js?v=1788700511"),
