const ABI = 3;
globalThis.JULIBROT_WORKER_URL = "./worker.js?v=1788539353";
...
async function boot() {
  try {
    const api = await import("./pkg/ember_lab_julibrot.js?v=1788539353");
    await api.default("./pkg/ember_lab_julibrot_bg.wasm?v=1788539353");
    ...
    facts.wasm_bundle_bytes = await artifactBytes("./pkg/ember_lab_julibrot_bg.wasm?v=1788539353");
    facts.javascript_bundle_bytes = await artifactBytes("./pkg/ember_lab_julibrot.js?v=1788539353");
