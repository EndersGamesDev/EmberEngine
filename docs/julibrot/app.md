...
`SceneUniform` is exactly 160 bytes: grid/span at 0/16, sampled basis at 32/48, sampled `M` at 64/80/96 with the applied apron in byte 108, and palette/interior/clear at 112/128/144; present owns one buffer for the main layer and one for the optional backdrop.
