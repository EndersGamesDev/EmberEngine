...
Native page-contract tests pin no wheel handler, click target, plain-drag pan, Shift-box zoom, scale range, all six object, ten camera, and five translation ids, both view boxes, row persistence, morph, loader `?v=1`, and ABI 3.
