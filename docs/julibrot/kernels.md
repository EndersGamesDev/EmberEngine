...
The selected `10⁻⁶` threshold flagged zero pixels in the 518,400-pixel zoom-14 seahorse corpus, and every non-glitch record was bit-identical to the detector-disabled CPU mirror; `10⁻⁴` flagged 38 pixels and `10⁻⁸` also flagged zero. A direct true-interior fixture at `c = 0` remains sampled through cap 512 rather than being flagged.
