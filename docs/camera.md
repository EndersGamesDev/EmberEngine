...
|6|`frame_points`|mutable view, two exact points, screen|Exact difference and midpoint; deterministic binary64 frame decomposition returns integer turns.|`2N M + 5N A`, `2N` midpoint shifts, plus at most `B(SM + 2I)` scale-fit work.|Not separately timed.|
