...
| **Loot L** ("train-zone block") | 6.0..7.0 | 9.6..10.6 | **2.30** | 3.30 | Off the C1 crossing exit. Walked under with 0.44 m of headroom; a floor jump meets it on the fourth integrator step after the press (0.55 m of rise against 0.44 m of headroom; the third step gives 0.42): the Mario snap. |
