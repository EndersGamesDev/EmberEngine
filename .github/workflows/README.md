...
The typed-web job installs the lockfile-matched wasm-bindgen CLI and stages declarations for each converted game's wasm before TypeScript runs, using the same script as Pages assembly and the required local gate.
