...
Repository working rules live in [`CLAUDE.md`](../CLAUDE.md), coordination rules live in [`docs/worker-protocol.md`](../docs/worker-protocol.md), and each child directory documents its own editing contract.
