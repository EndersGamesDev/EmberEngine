...
echo "== prebuilt mode fails closed on missing Julibrot artifacts =="
rm "$REPO/web/labs/julibrot/pkg/ember_lab_julibrot.js" "$REPO/web/labs/julibrot/pkg/ember_lab_julibrot_bg.wasm"
: > "$SHIM_LOG"
