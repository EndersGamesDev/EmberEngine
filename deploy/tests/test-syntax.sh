...
FILES="$(find "$DEPLOY" -name '*.sh' -print; ls "$HERE"/shims/ssh "$HERE"/shims/scp "$HERE"/shims/cargo "$HERE"/shims/wasm-bindgen "$HERE"/shims/git "$HERE"/shims/curl "$HERE"/shims/sleep "$HERE"/shims/node "$HERE"/shims/npm "$HERE"/shims/npx)"
