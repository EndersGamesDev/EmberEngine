...
use ember_game_arena_v6::proto::{C2S, S2C};
use ember_game_arena_v6::{ArenaCodec, ArenaFactory, FIXTURE_SUITE_ID};
use ember_legacy::{
...
#[test]
fn every_v6_wire_message_has_a_canonical_json_fixture() {
