...
/// Frozen Arena v2 proto version contract value.
pub const PROTO_VERSION: u16 = 2;
/// Frozen Arena v2 max handle len contract value.
pub const MAX_HANDLE_LEN: usize = 20;
/// Frozen Arena v2 max lobby len contract value.
pub const MAX_LOBBY_LEN: usize = 24;
/// Frozen Arena v2 max password len contract value.
pub const MAX_PASSWORD_LEN: usize = 40;
/// State broadcast every Nth sim tick (60 Hz sim -> 30 Hz state).
/// Frozen Arena v2 state every ticks contract value.
pub const STATE_EVERY_TICKS: u64 = 2;
/// Clients ping at least this often; the server drops peers silent > 30 s.
/// Frozen Arena v2 client ping secs contract value.
pub const CLIENT_PING_SECS: u64 = 5;

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq)]
/// Frozen Arena v2 LobbyInfo wire record.
pub struct LobbyInfo {
    /// Frozen Arena v2 name field.
    pub name: String,
    /// Frozen Arena v2 host field.
    pub host: String,
    /// Frozen Arena v2 has password field.
    pub has_password: bool,
    /// Frozen Arena v2 players field.
    pub players: u8,
    /// Frozen Arena v2 cap field.
    pub cap: u8,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
/// Frozen Arena v2 PlayerMeta wire record.
pub struct PlayerMeta {
    /// Frozen Arena v2 id field.
    pub id: u8,
    /// Frozen Arena v2 handle field.
    pub handle: String,
    /// Frozen Arena v2 color field.
    pub color: [f32; 3],
}

/// Per-player state inside a State broadcast.
#[derive(Serialize, Deserialize, Clone, Copy, Debug)]
/// Frozen Arena v2 PState wire record.
pub struct PState {
    /// Frozen Arena v2 id field.
    pub id: u8,
    /// Frozen Arena v2 x field.
    pub x: f32,
    /// Frozen Arena v2 z field.
    pub z: f32,
    /// Aim direction (normalized).
    /// Frozen Arena v2 ax field.
    pub ax: f32,
    /// Frozen Arena v2 az field.
    pub az: f32,
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug)]
/// Frozen Arena v2 BState wire record.
pub struct BState {
    /// Frozen Arena v2 x field.
    pub x: f32,
    /// Frozen Arena v2 z field.
    pub z: f32,
    /// Frozen Arena v2 vx field.
    pub vx: f32,
    /// Frozen Arena v2 vz field.
    pub vz: f32,
}
...
/// Frozen Arena v2 C2S message family.
pub enum C2S {
    /// Must be the first message on a connection.
    Hello {
        /// Frozen Arena v2 proto field.
        proto: u16,
        /// Frozen Arena v2 handle field.
        handle: String,
    },
    /// Frozen Arena v2 ListLobbies message.
    ListLobbies,
    CreateLobby {
        /// Frozen Arena v2 name field.
        name: String,
        /// Frozen Arena v2 password field.
    ...
    /// Frozen Arena v2 LeaveLobby message.
    LeaveLobby,
    /// Held intents: movement, aim, trigger. Doubles as the keepalive.
    Input {
        /// Frozen Arena v2 mx field.
        mx: f32,
        /// Frozen Arena v2 my field.
        my: f32,
        /// Frozen Arena v2 ax field.
        ax: f32,
        /// Frozen Arena v2 az field.
...
#[serde(tag = "t", rename_all = "snake_case")]
/// Frozen Arena v2 S2C message family.
pub enum S2C {
    Welcome {
        /// Frozen Arena v2 proto field.
        proto: u16,
        /// Frozen Arena v2 motd field.
        motd: String,
    },
    /// Recoverable failures (wrong password, name taken, ...). The
    /// connection stays open.
    Error {
        /// Frozen Arena v2 message field.
        message: String,
    },
    LobbyList {
        /// Frozen Arena v2 lobbies field.
    ...
    GameJoined {
        /// Frozen Arena v2 id field.
        id: u8,
        /// Frozen Arena v2 seed field.
        seed: u64,
        /// Frozen Arena v2 arena half field.
        arena_half: f32,
        /// Frozen Arena v2 players field.
        players: Vec<PlayerMeta>,
    },
    PlayerJoined {
        /// Frozen Arena v2 meta field.
        meta: PlayerMeta,
    },
    PlayerLeft {
        /// Frozen Arena v2 id field.
    ...
    Kill {
        /// Frozen Arena v2 killer field.
        killer: u8,
        /// Frozen Arena v2 victim field.
        victim: u8,
    },
    Pong {
        /// Frozen Arena v2 nonce field.
