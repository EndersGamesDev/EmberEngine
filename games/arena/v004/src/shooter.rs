...
/// Frozen Arena v4 arena half simulation value.
pub const ARENA_HALF: f32 = 24.0;
/// Frozen Arena v4 move speed simulation value.
pub const MOVE_SPEED: f32 = 9.0;
/// Shift: faster. C: slower (and a lower profile, cosmetically).
/// Frozen Arena v4 sprint mult simulation value.
pub const SPRINT_MULT: f32 = 1.6;
/// Frozen Arena v4 crouch mult simulation value.
pub const CROUCH_MULT: f32 = 0.55;
/// Frozen Arena v4 player r simulation value.
pub const PLAYER_R: f32 = 0.6;
/// Frozen Arena v4 bullet speed simulation value.
pub const BULLET_SPEED: f32 = 34.0;
/// Frozen Arena v4 bullet r simulation value.
pub const BULLET_R: f32 = 0.22;
/// Frozen Arena v4 bullet ttl simulation value.
pub const BULLET_TTL: f32 = 1.6;
/// Frozen Arena v4 fire cooldown simulation value.
pub const FIRE_COOLDOWN: f32 = 0.18;
/// Active bullets per player, so holding fire can't flood the state.
/// Frozen Arena v4 max bullets per player simulation value.
pub const MAX_BULLETS_PER_PLAYER: usize = 10;
/// Frozen Arena v4 max hp simulation value.
pub const MAX_HP: u8 = 3;
/// Frozen Arena v4 respawn secs simulation value.
pub const RESPAWN_SECS: f32 = 2.5;
/// Frozen Arena v4 max players simulation value.
...
pub struct PlayerSt {
    ...
    /// Frozen Arena v4 crouch field.
    pub crouch: bool,
    /// Frozen Arena v4 respawn in field.
    pub respawn_in: f32,
    /// Frozen Arena v4 cooldown field.
    pub cooldown: f32,
    deaths: u32,
}
...
pub struct Bullet {
    /// Frozen Arena v4 pos field.
    pub pos: [f32; 2],
    /// Frozen Arena v4 vel field.
    pub vel: [f32; 2],
    /// Frozen Arena v4 ttl field.
    pub ttl: f32,
    /// Frozen Arena v4 owner field.
    pub owner: u8,
}
...
pub struct Sim {
    ...
    /// Frozen Arena v4 events field.
    pub events: Vec<(u8, u8)>,
}

impl Sim {
    #[must_use]
    /// Executes the frozen Arena v4 new operation.
    ...
    /// Executes the frozen Arena v4 add player operation.
    ...
    /// Executes the frozen Arena v4 remove player operation.
