...
function loop(now) {
  ...
  $('shortcuts').textContent = state.pad ? 'Left stick move · Right stick look · □ interact · Hold L2 guard · Options menu' : document.pointerLockElement ? 'WASD move · E interact · Hold right mouse / F guard · V camera' : 'Click the game to look around · WASD move · E interact · F guard';
