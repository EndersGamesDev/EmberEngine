 ...
 * @param {number} stage_index
 * @param {number} stage_count
 * @param {number} kernel_index
 * @param {number} kernel_count
 * @param {number} sample_count
 * @param {number} sample_total
 * @returns {number}
 */
export function bar_progress_fraction(stage_index, stage_count, kernel_index, kernel_count, sample_count, sample_total) {
    const ret = wasm.bar_progress_fraction(stage_index, stage_count, kernel_index, kernel_count, sample_count, sample_total);
    return ret;
}
 ...
 */
export function cancel_gpu_compute() {
 ...
 * @returns {string}
 */
export function faer_wasm_verdict_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.faer_wasm_verdict_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @returns {string}
 */
export function float_probe_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.float_probe_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function gpu_compute_inventory_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.gpu_compute_inventory_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function gpu_compute_status_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.gpu_compute_status_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 */
export function initialize_gpu_compute_json() {
    const ret = wasm.initialize_gpu_compute_json();
    return ret;
}
 ...
 * @returns {Promise<string>}
 */
export function initialize_render_bar_json(canvas) {
    const ret = wasm.initialize_render_bar_json(canvas);
    return ret;
}
 ...
 * @returns {string}
 */
export function kernel_inventory_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.kernel_inventory_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {string}
 */
export function poll_submission_json() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.poll_submission_json();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
 ...
 * @returns {number}
 */
export function render_bar_frame(progress) {
    const ret = wasm.render_bar_frame(progress);
    if (ret[2]) {
 ...
 */
export function reset_render_bar() {
 ...
 * @returns {Promise<string>}
 */
export function run_gpu_compute_json(kernel_id, repeat_count) {
    const ptr0 = passStringToWasm0(kernel_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_gpu_compute_json(ptr0, len0, repeat_count);
    return ret;
}
 ...
 * @returns {number}
 */
export function run_jank_chunk() {
    const ret = wasm.run_jank_chunk();
    return ret;
}
 ...
 * @returns {number}
 */
export function run_kernel(kernel_id) {
    const ptr0 = passStringToWasm0(kernel_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_kernel(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 * @returns {number}
 */
export function run_kernel_repeated(kernel_id, repeat_count) {
    const ptr0 = passStringToWasm0(kernel_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_kernel_repeated(ptr0, len0, repeat_count);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0];
 ...
 */
export function start_submission(server_url, report_json) {
    const ptr0 = passStringToWasm0(server_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(report_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.start_submission(ptr0, len0, ptr1, len1);
    if (ret[1]) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_cceaf62d8d95e9f2: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined_______true_(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 2320, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 754, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 209, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__3);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("MessageEvent")], shim_idx: 209, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__4);
            return ret;
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 213, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
...
function wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__3(arg0, arg1, arg2) {
    wasm.wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__3(arg0, arg1, arg2);
}

function wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__4(arg0, arg1, arg2) {
    wasm.wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___web_sys_33dd3353a51540cc___features__gen_CloseEvent__CloseEvent______true__4(arg0, arg1, arg2);
}
...
function wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined_______true_(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen_e31f81090225b6ac___convert__closures_____invoke___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined___js_sys_c5e5247f2dacaf43___Function_fn_wasm_bindgen_e31f81090225b6ac___JsValue_____wasm_bindgen_e31f81090225b6ac___sys__Undefined_______true_(arg0, arg1, arg2, arg3);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('what_is_this_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
