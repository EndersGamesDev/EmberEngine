...
impl_wgsl_builtin!([F32Vec4; 4], "array<vec4<f32>, 4>", 64, 16, None);
...
mod tests {
    ...
    #[test]
    fn vector_and_array_primitives_have_host_shareable_rust_layouts() {
        let descriptions = [
        ...
        assert_eq!(
            <[F32Vec4; 4] as WgslType>::DESCRIPTION,
            WgslTypeDescription {
                name: "array<vec4<f32>, 4>",
                fields: &[],
                size: 64,
                alignment: 16,
                member_size: None,
