...
mod tests {
    ...
    crate::impl_wgsl_enum!(UnsignedMode, "UnsignedMode", u32, { Preview, Final });
    ...
    #[test]
    fn enum_macro_reads_unsigned_rust_discriminants() {
        let description = UnsignedMode::DESCRIPTION;
        assert_eq!(description.name, "UnsignedMode");
    ...
    #[test]
    fn enum_macro_reads_signed_rust_discriminants() {
        let description = SignedMode::DESCRIPTION;
        assert_eq!(description.name, "SignedMode");
        assert_eq!(description.variants[0].name, "Reverse");
        assert_eq!(
            description.variants[0].discriminant,
            WgslEnumDiscriminant::Signed(-3),
        );
        assert_eq!(description.variants[1].name, "Forward");
        assert_eq!(
            description.variants[1].discriminant,
            WgslEnumDiscriminant::Signed(5),
        );
    }
}
