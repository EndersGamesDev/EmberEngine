...
mod tests {
    ...
    fn rawgl_presentation_literals_and_wgpu_depth_conversion_are_pinned() {
        ...
        let required = [
            ...
            "camera_yaw_cosine * world.x + camera_yaw_sine * world.z",
            "-camera_yaw_sine * world.x + camera_yaw_cosine * world.z",
            "camera_pitch_cosine * yawed.y - camera_pitch_sine * yawed.z",
            "camera_pitch_sine * yawed.y + camera_pitch_cosine * yawed.z - 9.0",
