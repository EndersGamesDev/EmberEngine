...
///
/// Invoke this once as `::ember_julibrot_shader::production_template_test!` in a
...
/// `production_template_<render_fn>_renders_and_validates`. For example, renderer `shade_shader`
/// has test `production_template_shade_shader_renders_and_validates`. The deployment checker
